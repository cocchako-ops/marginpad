...
window.mpLoadCharts=function(cb){
  ...
  var sc=document.createElement('script'); sc.src='/assets/mp-charts.js?v=ce316ddc'; sc.defer=true;
...
(function(){
  ...
  function ensure(cb){
    ...
    loading=true;
    var sc=document.createElement('script'); sc.src='/assets/mp-mcharts.js?v=df1d228e'; sc.defer=true;
