...
window.mpLoadCharts=function(cb){
  ...
  var sc=document.createElement('script'); sc.src='/assets/mp-charts.js?v=f6420cfc'; sc.defer=true;
...
if(/^\/screener\/?$/.test(location.pathname)){var _ss=document.createElement('script');_ss.src='/assets/mp-screener.js?v=74086156';_ss.defer=true;document.head.appendChild(_ss);}
...
(function(){
  ...
  function ensure(cb){
    ...
    loading=true;
    var sc=document.createElement('script'); sc.src='/assets/mp-mcharts.js?v=85316191'; sc.defer=true;
