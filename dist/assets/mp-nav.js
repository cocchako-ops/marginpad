...
(function () {
  ...
  function wire() {
    ...
    var AUTH_JS = '/assets/mp-auth.js?v=98f62600', authLoading = null;
    function hasAuthTag() { try { return !!document.querySelector('script[src*="/assets/mp-auth.js?v=98f62600"]'); } catch (e) { return false; } }
