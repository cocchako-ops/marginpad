...
(function () {
  ...
  function wire() {
    ...
    var CHAT_JS = '/assets/mp-trade.js?v=f63c0bac', CHAT_CSS = '/assets/mp-trade.css?v=8a787d10', chatLoading = null;
    ...
    function chatCss() { if (document.querySelector('link[href*="/assets/mp-trade.css?v=8a787d10"]')) return; var l = document.createElement('link'); l.rel = 'stylesheet'; l.href = CHAT_CSS; document.head.appendChild(l); }
