...
(function () {
  ...
  function wire() {
    ...
    var AUTH_JS = '/assets/mp-auth.js?v=57dacf3f', authLoading = null;
    function hasAuthTag() { try { return !!document.querySelector('script[src*="/assets/mp-auth.js?v=57dacf3f"]'); } catch (e) { return false; } }
