...
(function () {
  ...
  function wire() {
    ...
    var CHAT_JS = '/assets/mp-trade.js?v=d37a6364', CHAT_CSS = '/assets/mp-trade.css?v=e5146110', chatLoading = null;
    ...
    var AUTH_JS = '/assets/mp-auth.js?v=1fd60faa', authLoading = null;
    function hasAuthTag() { try { return !!document.querySelector('script[src*="/assets/mp-auth.js?v=1fd60faa"]'); } catch (e) { return false; } }
