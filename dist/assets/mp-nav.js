...
(function () {
  ...
  function wire() {
    ...
    var AUTH_JS = '/assets/mp-auth.js?v=85737f48', authLoading = null;
    function hasAuthTag() { try { return !!document.querySelector('script[src*="/assets/mp-auth.js?v=85737f48"]'); } catch (e) { return false; } }
