...
(function () {
  ...
  function wire() {
    ...
    var CHAT_JS = '/assets/mp-trade.js?v=273c08bf', CHAT_CSS = '/assets/mp-trade.css?v=90d765d8', chatLoading = null;
    ...
    var AUTH_JS = '/assets/mp-auth.js?v=c2f066fd', authLoading = null;
    function hasAuthTag() { try { return !!document.querySelector('script[src*="/assets/mp-auth.js?v=c2f066fd"]'); } catch (e) { return false; } }
