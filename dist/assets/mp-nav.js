...
(function () {
  ...
  function canonHeaderHTML() {
    ...
    return '<div class="brand"><button type="button" class="hmenu" id="mBurger" aria-label="' + TR('navMenu') + '"><span></span><span></span><span></span></button>'
      ...
      + '<a href="/paper-trade?trades=1" class="hlink hjr"><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg>' + TR('hMyTrades') + '</a>'
      + '<button type="button" class="hlink hauth" data-auth-open aria-label="' + TR('hSignIn') + '"><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg><span data-auth-status>' + TR('hSignIn') + '</span></button>'
  ...
  function wire() {
    ...
    var CHAT_JS = '/assets/mp-trade.js?v=63bbf7bc', CHAT_CSS = '/assets/mp-trade.css?v=21ca5c15', chatLoading = null;
    ...
    function chatCss() { if (document.querySelector('link[href*="/assets/mp-trade.css?v=21ca5c15"]')) return; var l = document.createElement('link'); l.rel = 'stylesheet'; l.href = CHAT_CSS; document.head.appendChild(l); }
    ...
    var AUTH_JS = '/assets/mp-auth.js?v=580ed368', authLoading = null;
    function hasAuthTag() { try { return !!document.querySelector('script[src*="/assets/mp-auth.js?v=580ed368"]'); } catch (e) { return false; } }
