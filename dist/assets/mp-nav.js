...
(function () {
  ...
  function wire() {
    ...
    var AUTH_JS = '/assets/mp-auth.js?v=8dc9b500', authLoading = null;
    function hasAuthTag() { try { return !!document.querySelector('script[src*="/assets/mp-auth.js?v=8dc9b500"]'); } catch (e) { return false; } }
