...
(function () {
  ...
  var html = '<div class="mpnav-sheet"><div class="mpnav-head"><span class="mpnav-title">'+TR('brBrowse')+'</span><button type="button" class="mpnav-x" aria-label="'+TR('navClose')+'">&#10005;</button></div>'
    ...
    + row('Community', 'Trader posts, ideas & discussion', '/community/', '#c2f64a', 'users')
  ...
  function wire() {
    ...
    var CHAT_JS = '/assets/mp-trade.js?v=e79a9946', CHAT_CSS = '/assets/mp-trade.css?v=60c2dcb9', chatLoading = null;
    ...
    function chatCss() { if (document.querySelector('link[href*="/assets/mp-trade.css?v=60c2dcb9"]')) return; var l = document.createElement('link'); l.rel = 'stylesheet'; l.href = CHAT_CSS; document.head.appendChild(l); }
    ...
    var AUTH_JS = '/assets/mp-auth.js?v=20ed9e51', authLoading = null;
    function hasAuthTag() { try { return !!document.querySelector('script[src*="/assets/mp-auth.js?v=20ed9e51"]'); } catch (e) { return false; } }
