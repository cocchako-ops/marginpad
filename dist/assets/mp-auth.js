...
(function () {
  ...
  var css = '.mpa-modal{position:fixed;inset:0;z-index:2147483600;display:flex;align-items:center;justify-content:center;padding:18px;background:rgba(4,6,9,.7);-webkit-backdrop-filter:blur(5px);backdrop-filter:blur(5px)}'
    ...
    + '.lbm-card[class*="frame-"]::before{background:none}' // see note above: kills the inherited level accent bar on any frame that re-boxes ::before
    ...
    + '.lbm-card.frame-owner::after{content:"";position:absolute;inset:-13px;border-radius:26px;padding:13px;pointer-events:none;z-index:7;background:repeating-conic-gradient(from 0deg at 50% 50%,rgba(0,0,0,.20) 0 1.1deg,rgba(255,255,255,.05) 1.1deg 2.2deg,rgba(0,0,0,0) 2.2deg 4.4deg),conic-gradient(from var(--nvA,0deg),#4a3208,#c79a34 4%,#f6dd9a 8%,#fffdf2 11%,#e2bb56 16%,#7a5a14 21%,#1d2410 26%,#0d1206 30%,#1d2410 34%,#8a6a1c 39%,#f4c94a 44%,#fffdf2 48%,#f4c94a 52%,#8a6a1c 57%,#1d2410 62%,#0d1206 67%,#1d2410 71%,#7a5a14 76%,#e2bb56 81%,#fffdf2 88%,#c79a34 93%,#4a3208);box-shadow:inset 0 0 0 1.3px rgba(0,0,0,.8),inset 0 0 9px 2px rgba(0,0,0,.5),inset 0 0 0 2.6px rgba(120,88,16,.9),0 0 0 1px rgba(0,0,0,.6);-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude}'
    + '.lbm-card.frame-owner::before{content:"";position:absolute;inset:-25px;border-radius:34px;padding:12px;pointer-events:none;z-index:6;background:radial-gradient(circle 13px at 50% 0%,rgba(246,255,222,calc(.85 + .15*var(--nvP,.5))) 0 2.5px,#c2f64a 2.5px 6px,#7da31c 6px 9px,#3f550a 9px 10.4px,#ffe9a8 10.4px 12.2px,rgba(90,60,10,.95) 12.2px 13px,transparent 13px),radial-gradient(2.4px 2.4px at 34% 0%,rgba(255,246,200,.95),transparent 62%),radial-gradient(2.4px 2.4px at 66% 0%,rgba(255,246,200,.95),transparent 62%),radial-gradient(1.8px 1.8px at 22% 6%,rgba(255,238,176,.7),transparent 62%),radial-gradient(1.8px 1.8px at 78% 6%,rgba(255,238,176,.7),transparent 62%),radial-gradient(16px 44% at 0% 44%,#12160a 0 54%,#ffde7e 54% 62%,rgba(255,222,126,.45) 62% 74%,transparent 88%),radial-gradient(16px 44% at 100% 44%,#12160a 0 54%,#ffde7e 54% 62%,rgba(255,222,126,.45) 62% 74%,transparent 88%),repeating-linear-gradient(66deg,rgba(255,222,126,.8) 0 1.6px,transparent 1.6px 9px) 0 22%/26px 52% no-repeat,repeating-linear-gradient(-66deg,rgba(255,222,126,.8) 0 1.6px,transparent 1.6px 9px) 100% 22%/26px 52% no-repeat,linear-gradient(180deg,rgba(255,222,120,.95) 0 2px,#6d9418 2px 9px,#3f550a 9px 11px,rgba(255,222,120,.95) 11px 13px,transparent 13px) 50% 100%/62% 13px no-repeat,radial-gradient(circle 8px at 50% 100%,#fffdf2 0 3px,#c2f64a 3px 5.5px,#ffe9a8 5.5px 7px,transparent 7px),radial-gradient(circle 5px at 0% 0%,#fffdf2 0 2px,#8a6a1c 2px 4px,transparent 4px),radial-gradient(circle 5px at 100% 0%,#fffdf2 0 2px,#8a6a1c 2px 4px,transparent 4px),radial-gradient(circle 5px at 0% 100%,#fffdf2 0 2px,#8a6a1c 2px 4px,transparent 4px),radial-gradient(circle 5px at 100% 100%,#fffdf2 0 2px,#8a6a1c 2px 4px,transparent 4px),linear-gradient(rgba(0,0,0,0) 0 0);-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude}'
    + '.mpa-fr-sw.frame-owner::after{content:"";position:absolute;inset:-5px;border-radius:12px;padding:5px;pointer-events:none;z-index:7;background:repeating-conic-gradient(from 0deg at 50% 50%,rgba(0,0,0,.20) 0 1.1deg,rgba(255,255,255,.05) 1.1deg 2.2deg,rgba(0,0,0,0) 2.2deg 4.4deg),conic-gradient(from var(--nvA,0deg),#4a3208,#c79a34 4%,#f6dd9a 8%,#fffdf2 11%,#e2bb56 16%,#7a5a14 21%,#1d2410 26%,#0d1206 30%,#1d2410 34%,#8a6a1c 39%,#f4c94a 44%,#fffdf2 48%,#f4c94a 52%,#8a6a1c 57%,#1d2410 62%,#0d1206 67%,#1d2410 71%,#7a5a14 76%,#e2bb56 81%,#fffdf2 88%,#c79a34 93%,#4a3208);-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude}'
    + '.mpa-fr-sw.frame-owner::before{content:"";position:absolute;inset:-10px;border-radius:16px;padding:5px;pointer-events:none;z-index:6;background:radial-gradient(circle 6px at 50% 0%,#c2f64a 0 2.4px,#6d9418 2.4px 4.4px,#ffe9a8 4.4px 6px,transparent 6px),radial-gradient(16px 44% at 0% 44%,#12160a 0 54%,#ffde7e 54% 62%,rgba(255,222,126,.45) 62% 74%,transparent 88%),radial-gradient(16px 44% at 100% 44%,#12160a 0 54%,#ffde7e 54% 62%,rgba(255,222,126,.45) 62% 74%,transparent 88%),linear-gradient(rgba(0,0,0,0) 0 0);-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude}'
    ...
    + '.lbm-card.frame-regalia::after{content:"";position:absolute;inset:-13px;border-radius:26px;padding:13px;pointer-events:none;z-index:7;background:repeating-conic-gradient(from 0deg at 50% 50%,rgba(0,0,0,.20) 0 1.1deg,rgba(255,255,255,.05) 1.1deg 2.2deg,rgba(0,0,0,0) 2.2deg 4.4deg),conic-gradient(from var(--nvA,0deg),#4a3208,#c79a34 4%,#f6dd9a 8%,#fff6d2 11%,#d9a93c 16%,#7a5a14 21%,#243056 26%,#0e1428 30%,#243056 34%,#8a6a1c 39%,#e2bb56 44%,#fff6d2 48%,#e2bb56 52%,#8a6a1c 57%,#243056 62%,#0e1428 67%,#243056 71%,#7a5a14 76%,#d9a93c 81%,#fff6d2 88%,#c79a34 93%,#4a3208);box-shadow:inset 0 0 0 1.3px rgba(0,0,0,.8),inset 0 0 9px 2px rgba(0,0,0,.5),inset 0 0 0 2.6px rgba(120,84,18,.9),0 0 0 1px rgba(0,0,0,.6);-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude}'
    + '.lbm-card.frame-regalia::before{content:"";position:absolute;inset:-25px;border-radius:34px;padding:12px;pointer-events:none;z-index:6;background:radial-gradient(circle 13px at 50% 0%,rgba(255,232,232,calc(.8 + .2*var(--nvP,.5))) 0 2.5px,#ff4d5e 2.5px 6px,#b60f22 6px 9px,#6d0715 9px 10.4px,#ffe9a8 10.4px 12.2px,rgba(90,60,10,.95) 12.2px 13px,transparent 13px),radial-gradient(2.4px 2.4px at 34% 0%,rgba(255,238,176,.95),transparent 62%),radial-gradient(2.4px 2.4px at 66% 0%,rgba(255,238,176,.95),transparent 62%),radial-gradient(1.8px 1.8px at 22% 6%,rgba(255,230,160,.7),transparent 62%),radial-gradient(1.8px 1.8px at 78% 6%,rgba(255,230,160,.7),transparent 62%),radial-gradient(16px 44% at 0% 44%,#0c1430 0 54%,#e8ba56 54% 62%,rgba(232,186,86,.45) 62% 74%,transparent 88%),radial-gradient(16px 44% at 100% 44%,#0c1430 0 54%,#e8ba56 54% 62%,rgba(232,186,86,.45) 62% 74%,transparent 88%),repeating-linear-gradient(66deg,rgba(232,186,86,.75) 0 1.6px,transparent 1.6px 9px) 0 22%/26px 52% no-repeat,repeating-linear-gradient(-66deg,rgba(232,186,86,.75) 0 1.6px,transparent 1.6px 9px) 100% 22%/26px 52% no-repeat,linear-gradient(180deg,rgba(226,178,74,.9) 0 2px,#a80e20 2px 9px,#6d0715 9px 11px,rgba(226,178,74,.9) 11px 13px,transparent 13px) 50% 100%/62% 13px no-repeat,radial-gradient(circle 8px at 50% 100%,#ffe9a8 0 3px,#a80e20 3px 5.5px,#ffe9a8 5.5px 7px,transparent 7px),radial-gradient(circle 5px at 0% 0%,#ffe9a8 0 2px,#8a6a1c 2px 4px,transparent 4px),radial-gradient(circle 5px at 100% 0%,#ffe9a8 0 2px,#8a6a1c 2px 4px,transparent 4px),radial-gradient(circle 5px at 0% 100%,#ffe9a8 0 2px,#8a6a1c 2px 4px,transparent 4px),radial-gradient(circle 5px at 100% 100%,#ffe9a8 0 2px,#8a6a1c 2px 4px,transparent 4px),linear-gradient(rgba(0,0,0,0) 0 0);-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude}'
    + '.mpa-fr-sw.frame-regalia::after{content:"";position:absolute;inset:-5px;border-radius:12px;padding:5px;pointer-events:none;z-index:7;background:repeating-conic-gradient(from 0deg at 50% 50%,rgba(0,0,0,.20) 0 1.1deg,rgba(255,255,255,.05) 1.1deg 2.2deg,rgba(0,0,0,0) 2.2deg 4.4deg),conic-gradient(from var(--nvA,0deg),#4a3208,#c79a34 4%,#f6dd9a 8%,#fff6d2 11%,#d9a93c 16%,#7a5a14 21%,#243056 26%,#0e1428 30%,#243056 34%,#8a6a1c 39%,#e2bb56 44%,#fff6d2 48%,#e2bb56 52%,#8a6a1c 57%,#243056 62%,#0e1428 67%,#243056 71%,#7a5a14 76%,#d9a93c 81%,#fff6d2 88%,#c79a34 93%,#4a3208);-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude}'
    + '.mpa-fr-sw.frame-regalia::before{content:"";position:absolute;inset:-10px;border-radius:16px;padding:5px;pointer-events:none;z-index:6;background:radial-gradient(circle 6px at 50% 0%,#ff6070 0 2.4px,#a00d1e 2.4px 4.4px,#ffe9a8 4.4px 6px,transparent 6px),radial-gradient(16px 44% at 0% 44%,#0c1430 0 54%,#e8ba56 54% 62%,rgba(232,186,86,.45) 62% 74%,transparent 88%),radial-gradient(16px 44% at 100% 44%,#0c1430 0 54%,#e8ba56 54% 62%,rgba(232,186,86,.45) 62% 74%,transparent 88%),linear-gradient(rgba(0,0,0,0) 0 0);-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude}'
    ...
    + '.lbm-card.frame-supernova::after{content:"";position:absolute;inset:-11px;border-radius:24px;padding:11px;pointer-events:none;z-index:7;background:conic-gradient(from var(--nvA,0deg),#2b0140,#7a3cff 8%,#25d3ff 19%,#a9ffea 27%,#fff6c8 35%,#ffb62e 44%,#ff4d2a 54%,#ff2ea8 66%,#7a3cff 78%,#1b0a40 90%,#2b0140);box-shadow:inset 0 0 0 1.3px rgba(0,0,0,.7),inset 0 0 8px 2px rgba(0,0,0,.45),0 0 0 1px rgba(0,0,0,.55);filter:saturate(1.35) brightness(calc(.92 + .3*var(--nvP,.5)));-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude}'
    + '.mpa-fr-sw.frame-supernova::after{content:"";position:absolute;inset:-5px;border-radius:12px;padding:5px;pointer-events:none;z-index:7;background:conic-gradient(from var(--nvA,0deg),#2b0140,#7a3cff 8%,#25d3ff 19%,#a9ffea 27%,#fff6c8 35%,#ffb62e 44%,#ff4d2a 54%,#ff2ea8 66%,#7a3cff 78%,#1b0a40 90%,#2b0140);-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude}'
