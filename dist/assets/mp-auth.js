...
(function () {
  ...
  var css = '.mpa-modal{position:fixed;inset:0;z-index:2147483600;display:flex;align-items:center;justify-content:center;padding:18px;background:rgba(4,6,9,.7);-webkit-backdrop-filter:blur(5px);backdrop-filter:blur(5px)}'
    ...
    + '.lbm-card.frame-owner,.mpa-fr-sw.frame-owner{position:relative;border-color:transparent;box-shadow:0 0 0 1px rgba(255,232,140,calc(.6 + .35*var(--nvP,.5))),0 0 calc(30px + 26px*var(--nvP,.5)) -6px rgba(255,205,80,calc(.55 + .35*var(--nvP,.5))),0 0 calc(92px + 48px*var(--nvP,.5)) -20px rgba(255,182,52,.6),0 0 180px -40px rgba(194,246,74,calc(.18 + .22*var(--nvP,.5))),inset 0 0 62px -24px rgba(255,238,164,.92),0 26px 88px -30px rgba(0,0,0,.9)}'
    + '.lbm-card.frame-owner::after,.mpa-fr-sw.frame-owner::after{content:"";position:absolute;inset:-3.2px;border-radius:inherit;padding:3.2px;pointer-events:none;z-index:7;background:conic-gradient(from var(--nvA,0deg),#5a3a08,#ffd75a 6%,#fffdf2 10%,#ffd75a 15%,#1d2410 23%,#0d1206 28%,#1d2410 33%,#f4c94a 42%,#fff7d8 48%,#e2a92e 55%,#1d2410 63%,#0d1206 68%,#1d2410 73%,#ffcf3f 82%,#fffdf2 90%,#5a3a08);-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude}'
    + '.lbm-card.frame-owner::before,.mpa-fr-sw.frame-owner::before{content:"";position:absolute;inset:0;border-radius:inherit;pointer-events:none;z-index:6;background:'
      + 'radial-gradient(circle 7.2px at 50% 10px,rgba(244,255,214,calc(.85 + .15*var(--nvP,.5))) 0 1.5px,#c2f64a 1.5px 3.5px,#6d9418 3.5px 5.6px,#ffe9a8 5.6px 6.8px,rgba(120,80,14,.9) 6.8px 7.6px,transparent 7.6px),'
      + 'radial-gradient(1.7px 1.7px at 33% 13%,rgba(255,244,190,.95),transparent 60%),radial-gradient(1.7px 1.7px at 67% 13%,rgba(255,244,190,.95),transparent 60%),radial-gradient(1.4px 1.4px at 21% 23%,rgba(255,236,170,.65),transparent 60%),radial-gradient(1.4px 1.4px at 79% 23%,rgba(255,236,170,.65),transparent 60%),'
      + 'radial-gradient(circle 4.6px at 50% calc(100% - 13px),#fffdf2 0 2px,rgba(194,246,74,.9) 2px 3.4px,rgba(240,206,110,.95) 3.4px 4.6px,transparent 4.6px),'
      + 'linear-gradient(180deg,transparent 0 calc(100% - 20px),rgba(255,222,120,.7) calc(100% - 20px) calc(100% - 18.8px),rgba(190,146,40,.5) calc(100% - 18.8px) calc(100% - 7px),rgba(255,222,120,.7) calc(100% - 7px) calc(100% - 5.8px),transparent calc(100% - 5.8px)),'
      + 'linear-gradient(90deg,rgba(26,32,14,.8) 0 14%,transparent 14% 86%,rgba(26,32,14,.8) 86%) 0 100%/100% 20px no-repeat,'
      + 'linear-gradient(90deg,rgba(18,22,9,.97) 0 42%,rgba(18,22,9,.6) 70%,transparent) 0 0/21% 100% no-repeat,linear-gradient(270deg,rgba(18,22,9,.97) 0 42%,rgba(18,22,9,.6) 70%,transparent) 100% 0/21% 100% no-repeat,'
      + 'linear-gradient(74deg,transparent 0 30%,rgba(255,222,126,.62) 30% 31.8%,transparent 31.8% 50%,rgba(255,222,126,.44) 50% 51.6%,transparent 51.6% 70%,rgba(255,222,126,.3) 70% 71.4%,transparent 71.4%) 0 0/19% 100% no-repeat,'
      + 'linear-gradient(-74deg,transparent 0 30%,rgba(255,222,126,.62) 30% 31.8%,transparent 31.8% 50%,rgba(255,222,126,.44) 50% 51.6%,transparent 51.6% 70%,rgba(255,222,126,.3) 70% 71.4%,transparent 71.4%) 100% 0/19% 100% no-repeat,'
      + 'linear-gradient(115deg,transparent 38%,rgba(255,246,208,.18) 46%,rgba(255,255,255,calc(.3 + .3*var(--nvP,.5))) 50%,rgba(255,246,208,.18) 54%,transparent 62%) calc(50% + 60% * var(--nvF,0)) 0/240% 100% no-repeat,'
      + 'radial-gradient(72% 78% at 50% 42%,rgba(120,86,10,calc(.2 + .12*var(--nvP,.5))),transparent 74%)}'
    ...
    + '.lbm-card.frame-regalia,.mpa-fr-sw.frame-regalia{position:relative;border-color:transparent;box-shadow:0 0 0 1px rgba(226,178,74,.85),0 0 calc(24px + 16px*var(--nvP,.5)) -10px rgba(198,26,44,calc(.4 + .3*var(--nvP,.5))),0 0 78px -26px rgba(226,178,74,.55),inset 0 0 56px -18px rgba(140,10,24,.8),0 20px 60px -28px rgba(0,0,0,.9)}'
    + '.lbm-card.frame-regalia::after,.mpa-fr-sw.frame-regalia::after{content:"";position:absolute;inset:-3px;border-radius:inherit;padding:3px;pointer-events:none;z-index:7;background:conic-gradient(from var(--nvA,0deg),#6b4a12,#f0d27a 5%,#fff3c4 9%,#d9a93c 15%,#243056 24%,#0e1428 29%,#243056 34%,#c9982f 42%,#ffe9a8 47%,#b8791f 54%,#243056 62%,#0e1428 67%,#243056 72%,#d9a93c 80%,#fff3c4 88%,#6b4a12);-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude}'
    + '.lbm-card.frame-regalia::before,.mpa-fr-sw.frame-regalia::before{content:"";position:absolute;inset:0;border-radius:inherit;pointer-events:none;z-index:6;background:'
      + 'radial-gradient(circle 7px at 50% 10px,rgba(255,226,226,calc(.85 + .15*var(--nvP,.5))) 0 1.4px,#ff4d5e 1.4px 3.4px,#b60f22 3.4px 5.4px,#ffe9a8 5.4px 6.6px,rgba(120,80,14,.9) 6.6px 7.4px,transparent 7.4px),' // the ruby, in its setting
      + 'radial-gradient(1.6px 1.6px at 33% 13%,rgba(255,236,170,.9),transparent 60%),radial-gradient(1.6px 1.6px at 67% 13%,rgba(255,236,170,.9),transparent 60%),radial-gradient(1.3px 1.3px at 22% 22%,rgba(255,236,170,.6),transparent 60%),radial-gradient(1.3px 1.3px at 78% 22%,rgba(255,236,170,.6),transparent 60%),' // crown stars
      + 'radial-gradient(circle 4.5px at 50% calc(100% - 13px),#ffe9a8 0 2px,rgba(160,14,30,.95) 2px 3.4px,rgba(226,178,74,.9) 3.4px 4.5px,transparent 4.5px),' // ribbon medallion
      + 'linear-gradient(180deg,transparent 0 calc(100% - 20px),rgba(226,178,74,.6) calc(100% - 20px) calc(100% - 18.8px),rgba(168,14,32,.55) calc(100% - 18.8px) calc(100% - 7px),rgba(226,178,74,.6) calc(100% - 7px) calc(100% - 5.8px),transparent calc(100% - 5.8px)),' // the ribbon band
      + 'linear-gradient(90deg,rgba(24,32,62,.85) 0 14%,transparent 14% 86%,rgba(24,32,62,.85) 86%) 0 100%/100% 20px no-repeat,' // its navy tails
      + 'linear-gradient(74deg,transparent 0 30%,rgba(232,186,86,.6) 30% 31.8%,transparent 31.8% 50%,rgba(232,186,86,.42) 50% 51.6%,transparent 51.6% 70%,rgba(232,186,86,.3) 70% 71.4%,transparent 71.4%) 0 0/19% 100% no-repeat,' // left wing feathers
      + 'linear-gradient(-74deg,transparent 0 30%,rgba(232,186,86,.6) 30% 31.8%,transparent 31.8% 50%,rgba(232,186,86,.42) 50% 51.6%,transparent 51.6% 70%,rgba(232,186,86,.3) 70% 71.4%,transparent 71.4%) 100% 0/19% 100% no-repeat,' // right wing feathers
      + 'linear-gradient(90deg,rgba(11,16,36,.97) 0 42%,rgba(11,16,36,.6) 70%,transparent) 0 0/21% 100% no-repeat,linear-gradient(270deg,rgba(11,16,36,.97) 0 42%,rgba(11,16,36,.6) 70%,transparent) 100% 0/21% 100% no-repeat,' // the wing bodies: a solid dark mass down each outer edge. A soft radial read as a smudge at real card size.
      + 'radial-gradient(72% 78% at 50% 42%,rgba(122,8,20,calc(.22 + .12*var(--nvP,.5))),transparent 74%)}' // the deep red the crest sits in
