...
const PAGES = {
  ...
  'hyperliquid-whales': ['TRADE THE SAME BOOK AS THE WHALES', 'Every position on this page is on Hyperliquid, fully on-chain and readable by anyone &mdash; including yours, once you have one.'],
  ...
  'exchanges': ['THE DEX IN THIS COMPARISON', 'Hyperliquid is the on-chain perps exchange every centralised venue on this page is now measured against. Wallet in, trade, wallet out &mdash; and 4% off fees with our code.'],
...
const DISC = 'Referral link &mdash; MarginPad may earn a commission if you open an account. The 4% fee discount is Hyperliquid&rsquo;s referral discount; you never pay more than you would going direct. Not available to US persons under Hyperliquid&rsquo;s terms.';
...
<div class="mp-hl-row">
<div class="mp-hl-main"><div class="mp-hl-t">Hyperliquid &mdash; perps <b>on-chain</b>, with a fee discount from us.</div><p class="mp-hl-w">${why}</p></div>
