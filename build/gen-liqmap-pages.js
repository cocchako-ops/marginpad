...
const faq = (name, sym) => [
  ...
  { q: `Is the ${name} liquidation map free?`, a: `The map opens without a signup and the live heatmap runs free for a 5-minute preview; unlimited access is part of MarginPad Premium ($11.99/mo). You can switch coins, change the timeframe (1D/1W/1M/1Y), and toggle the real, estimated and theoretical layers.` },
];
