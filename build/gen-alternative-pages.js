...
const PAGES = [
  {
    ...
    rows: [
      ...
      ['Real-time liquidation feed', 'Free — 10 exchanges (Binance, Bybit, OKX, Hyperliquid, Gate, HTX, dYdX, BitMEX, Deribit, Bitfinex)', 'Available; depth varies by plan'],
    ...
    faq: [
      ...
      { q: 'Where does MarginPad liquidation data come from?', a: 'MarginPad runs its own collector subscribed to the public liquidation websockets of 10 exchanges (Binance, Bybit, OKX, Hyperliquid, Gate, HTX, dYdX, BitMEX, Deribit, Bitfinex), and aggregates per-coin 24h totals from Coinglass. Real events and estimates are always labelled separately.' },
