...
const T = {
  // es removed 2026-09-12: Spanish is the full /es/blog/<slug>/ twin (build/es/gen-pages.js); the worker 301s /blog/<slug>/es/ there
  ...
  sv: { lang: 'sv', name: 'Svenska', title: 'Så beräknar du likvidationspris för krypto', desc: 'Formeln för likvidationspris vid kryptoterminer, med exempel, för valfri hävstång — lång eller kort.', lead: 'Ditt likvidationspris är nivån där börsen tvångsstänger din hävstångsposition. Här är formeln och hur du beräknar din.', h2a: 'Likvidationsformeln', pa: 'För en position med isolerad margin är det uppskattade likvidationspriset <code>Ingång × (1 − 1/Hävstång + MMR)</code> för lång och <code>Ingång × (1 + 1/Hävstång − MMR)</code> för kort, där MMR är underhållsmarginalkvoten (ofta omkring 0,5 %). Högre hävstång flyttar likvidationen närmare din ingång.', h2b: 'Räkneexempel', pb: 'En 10×-lång på BTC som öppnas vid 60 000 $ med 0,5 % MMR likvideras nära 54 300 $ — ett fall på cirka 9,5 %. Samma position vid 100× likvideras efter en rörelse på cirka 1 %.', cta: 'Hitta ditt exakta likvidationspris med den gratis kalkylatorn →' },
  no: { lang: 'no', name: 'Norsk', title: 'Slik beregner du likvidasjonspris for krypto', desc: 'Formelen for likvidasjonspris ved kryptofutures, med eksempel, for enhver giring — long eller short.', lead: 'Likvidasjonsprisen din er nivået der børsen tvangslukker giringsposisjonen din. Her er formelen og hvordan du beregner din.', h2a: 'Likvidasjonsformelen', pa: 'For en posisjon med isolert margin er estimert likvidasjonspris <code>Inngang × (1 − 1/Giring + MMR)</code> for long og <code>Inngang × (1 + 1/Giring − MMR)</code> for short, der MMR er vedlikeholdsmarginraten (ofte rundt 0,5 %). Høyere giring flytter likvidasjonen nærmere inngangen din.', h2b: 'Regneeksempel', pb: 'En 10×-long på BTC åpnet ved 60 000 $ med 0,5 % MMR likvideres nær 54 300 $ — et fall på rundt 9,5 %. Samme posisjon ved 100× likvideres etter en bevegelse på rundt 1 %.', cta: 'Finn din nøyaktige likvidasjonspris med den gratis kalkulatoren →' },
  da: { lang: 'da', name: 'Dansk', title: 'Sådan beregner du likvidationspris for krypto', desc: 'Formlen for likvidationspris ved kryptofutures, med eksempel, for enhver gearing — long eller short.', lead: 'Din likvidationspris er det niveau, hvor børsen tvangslukker din gearede position. Her er formlen, og hvordan du beregner din.', h2a: 'Likvidationsformlen', pa: 'For en position med isoleret margin er den estimerede likvidationspris <code>Indgang × (1 − 1/Gearing + MMR)</code> for long og <code>Indgang × (1 + 1/Gearing − MMR)</code> for short, hvor MMR er vedligeholdelsesmargin-satsen (ofte omkring 0,5 %). Højere gearing rykker likvidationen tættere på din indgang.', h2b: 'Regneeksempel', pb: 'En 10×-long på BTC åbnet ved 60.000 $ med 0,5 % MMR likvideres nær 54.300 $ — et fald på cirka 9,5 %. Samme position ved 100× likvideres efter en bevægelse på cirka 1 %.', cta: 'Find din præcise likvidationspris med den gratis beregner →' },
  fi: { lang: 'fi', name: 'Suomi', title: 'Näin lasket krypton likvidaatiohinnan', desc: 'Likvidaatiohinnan kaava kryptofutuureille, esimerkin kanssa, mille tahansa vivulle — long tai short.', lead: 'Likvidaatiohinta on taso, jolla pörssi sulkee vivutetun positiosi pakolla. Tässä on kaava ja miten lasket omasi.', h2a: 'Likvidaatiokaava', pa: 'Eristetyn marginaalin positiolle arvioitu likvidaatiohinta on <code>Sisääntulo × (1 − 1/Vipu + MMR)</code> longille ja <code>Sisääntulo × (1 + 1/Vipu − MMR)</code> shortille, jossa MMR on ylläpitomarginaaliprosentti (usein noin 0,5 %). Suurempi vipu siirtää likvidaation lähemmäs sisääntuloasi.', h2b: 'Laskuesimerkki', pb: '60 000 dollarilla avattu 10×-long BTC:ssä 0,5 %:n MMR:llä likvidoituu lähellä 54 300 dollaria — noin 9,5 %:n lasku. Sama positio 100×:llä likvidoituu noin 1 %:n liikkeen jälkeen.', cta: 'Selvitä tarkka likvidaatiohintasi ilmaisella laskurilla →' },
};
...
try {
  ...
  en = en.replace(/\n?<link rel="alternate" hreflang="[^"]*" href="[^"]*" \/>/g, ''); // drop any stale set first
