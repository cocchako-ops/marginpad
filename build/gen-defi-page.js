...
<div class="wrap">
  ...
  <footer>
    ...
    <span><a href="/screener">Screener</a> · <a href="/funding/">Funding</a> · <a href="/liquidations/">Liquidations</a> · <a href="/defi/">DeFi</a> &middot; <a href="/terms/">Terms</a> &middot; <a href="/privacy/">Privacy</a></span>
  </footer>
</div>
<script>(function(){
  ...
  (function(){var ls=document.getElementById('langSel');if(!ls)return;var seg=location.pathname.split('/')[1];if(seg&&seg.length===2)ls.value='/'+seg+'/defi/';ls.addEventListener('change',function(){var v=this.value,m=(v.match(/^\/([a-z]{2})\//)||[])[1]||'en';try{localStorage.setItem('mp_lang',m);}catch(e){}location.href=v;});})();
