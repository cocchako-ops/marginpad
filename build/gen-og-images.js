...
function plan(rel, html) {
  ...
  const ONE = {
    ...
    '/academy/': ['product', { title: 'Learn futures properly', sub: '17 courses, 147 lessons, in 13 languages. Free.', accent: ACCENT.blue, path: '/academy/', points: ['16 courses', '140 lessons', '13 languages'], tag: 'FREE' }],
  ...
  if (/^\/(how-many-traders-liquidated-today|longs-or-shorts-liquidated-more|biggest-liquidation-today|is-funding-positive-or-negative|crypto-liquidations-today|where-can-i-test-a-trading-bot|mcp-server-for-crypto-trading|practice-for-a-funded-account|what-leverage-should-a-beginner-use)\/$/.test(rel)) {
    const A = { 'how-many-traders-liquidated-today': 'Counted every hour', 'longs-or-shorts-liquidated-more': 'Longs vs shorts, live',
      'biggest-liquidation-today': 'The single largest', 'is-funding-positive-or-negative': 'Who pays whom', 'crypto-liquidations-today': 'Today, so far', 'where-can-i-test-a-trading-bot': 'Free, on live prices', 'mcp-server-for-crypto-trading': 'One line of config', 'practice-for-a-funded-account': 'Our own pass rate', 'what-leverage-should-a-beginner-use': 'Counted, not guessed' };
