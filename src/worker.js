...
.fe.k-money{border-left-color:#ffd75a}.fe.k-trade{border-left-color:#2ebd85}.fe.k-acct{border-left-color:#c2f64a}.fe.k-tool{border-left-color:#38bdf8}.fe.k-page{border-left-color:#2c384e}.fe.k-other{border-left-color:#39445a}
...
<div class="ovv-p" style="margin-top:12px"><div class="ovv-ph">Community <span>latest posts &middot; you also get a Telegram ping per post</span></div><div class="list">${commList}</div></div>
  ...
  function evKindOf(t){if(t==='exchange')return 'money';if(t==='paper'||t==='hotpair')return 'trade';if(t==='signup'||t==='login'||t==='claim'||t==='withdraw'||t==='mission'||t==='academy'||t==='post')return 'acct';if(t==='tool')return 'tool';if(t==='pv')return 'page';return 'other';}
  ...
  function evPass(x){var k=evKindOf(x._pg?'pv':x.t),f=EV.filt;if(f==='all')return true;if(f==='money')return k==='money';if(f==='trade')return k==='trade';if(f==='acct')return k==='acct';if(f==='page')return k==='page';return true;}
