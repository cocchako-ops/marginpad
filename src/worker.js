...
var ovDays=[],ovState=null;
function ovMoney(v){return '$'+Math.round(+v||0).toLocaleString('en-US');}
function loadOverview(){if(document.hidden)return;if(ovState==='loading')return;ovState='loading';
  Promise.all([
    fetch('/api/admin/funnel').then(function(r){return r.json();}).catch(function(){return null;}),
    fetch('/api/admin/revenue').then(function(r){return r.json();}).catch(function(){return null;}),
    fetch('/api/admin/seo').then(function(r){return r.json();}).catch(function(){return null;}),
    fetch('/api/admin/withdrawals').then(function(r){return r.json();}).catch(function(){return null;}),
    fetch('/api/admin/health').then(function(r){return r.json();}).catch(function(){return null;})
