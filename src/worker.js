...
async function handleStats(url, env) {
  ...
  const pvDays = {}, affDays = {}, hours = {}, langs = []; let online = 0;
  all.forEach(k => {
    const n = k.n, c = k.c;
  ...
  [pages, geo, refs, ex, tools, tabs, els, other, botCmds, devices, browsers, cmtPosts, langs].forEach(a => a.sort((x, y) => y[1] - x[1]));
