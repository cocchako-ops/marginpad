...
function loadCommunity(){
  fetch('/api/admin/community').then(function(r){return r.json();}).then(function(d){
    var t=d.totals||{};
...
function loadRetention(retry){
  fetch('/api/admin/retention').then(function(r){return r.json();}).then(function(d){
    if((d.transient||!(d.cohorts&&d.cohorts.length))&&!retry){setTimeout(function(){loadRetention(1);},1500);return;} // a deploy resets the DO mid-flight — one silent retry instead of an empty tab
...
function loadRevenue(retry){
  fetch('/api/admin/revenue').then(function(r){return r.json();}).then(function(d){
...
function loadApi(){
  ...
  fetch('/api/admin/apistats').then(function(r){return r.json();}).then(function(d){
...
if(gsIn){
  gsIn.addEventListener('input',function(){
    ...
    gsT=setTimeout(function(){
      var seq=++gsSeq;
      fetch('/api/admin/search?q='+encodeURIComponent(q)).then(function(r){return r.json();}).then(function(d){if(seq===gsSeq)gsRender(d||{});}).catch(function(){});
    },280);
  });
