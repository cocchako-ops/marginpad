...
function renderOpsViz(){
  ...
  if(!host.querySelector('.ovz-grid')){
    host.innerHTML='<div class="ovz-grid"><div class="ovz-p" id="ovzLeft"></div><div class="ovz-p" id="ovzMid"><div class="ovz-h"><span class="ovz-lv"><i></i>LIVE</span>Coins → direction → traders · ribbon = margin · hover a node to isolate its flows</div><div id="ovzSvg"></div></div><div class="ovz-p" id="ovzRight"></div></div>'
      ...
      +'<div class="ovz-p"><div class="ovz-h">Trade tape <span style="color:#31405c;text-transform:none;letter-spacing:0">&middot; last 48h &middot; closes carry the trader&#39;s REAL P&amp;L</span></div><div id="ovzTape"></div></div>'
  ...
  var mergedTape=(OPS.srv||[]).map(function(ev){return {at:+ev.ts,kind:ev.kind==='close'?(ev.liq?'liqclose':'close'):ev.kind,srv:1,pnl:(ev.pnl!=null?+ev.pnl:null),t:{sym:ev.sym,side:ev.side,lev:ev.lev,margin:ev.margin,username:ev.username,email:ev.email}};});
