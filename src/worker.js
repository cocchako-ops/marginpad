...
function loadRetention(retry){
  fetch('/api/admin/retention?_='+Date.now()).then(function(r){return r.json();}).then(function(d){
...
function loadRevenue(retry){
  fetch('/api/admin/revenue?_='+Date.now()).then(function(r){return r.json();}).then(function(d){
